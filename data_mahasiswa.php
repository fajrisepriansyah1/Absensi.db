    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron">
                ...
                <div class="col-md-12">
                    <p>
                        <a class="btn btn-primary" href="tambah_mahasiswa.php" role="button">Tambah Mahasiswa</a>
                    </p>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    if(count(Baca_Data_Mahasiswa()) > 0) {
                                        foreach(Baca_Data_Mahasiswa() as $mhs) {
                                    ?>
                                    <tr>
                                        ...
                                        <td scope="row">
                                            <a class="btn btn-warning" href="edit_mahasiswa.php?nim=<?php echo $mhs['nim']; ?>">Edit</a>

                                            <a class="btn btn-danger" href="hapus_mahasiswa.php?nim=<?php echo $mhs['nim']; ?>">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php } // ini tutup while ?>
                                    <?php } else { // ini dari if else ?>
                                    <tr>
                                        <td colspan="3">Data mahasiswa kosong!</td>
                                    </tr>
                                    <?php } // ini tutup else ?>
                                </tbody>
                            </table>
