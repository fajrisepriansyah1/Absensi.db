...
<html lang="id">
    ...
    <body>
        <div class="container">
            ...
            <div class="col-md-12">
			    <form class="form-signin" action="proses_login_admin.php" method="POST">
			        <div style="text-align: center;">
			        	<h3 class="form-signin-heading">Login Admin</h3>
			        </div>
			        <label for="inputNim" class="sr-only">NIM Khusus Admin</label>
			        <input name="nim_admin" type="text" id="inputNim" class="form-control" placeholder="NIM Khusus Admin" required autofocus>
			        <br>
			        <button class="btn btn-lg btn-primary btn-block" type="submit">Masuk</button>
			        <a href="index.php" class="btn btn-lg btn-link btn-block">Kembali</a>
			    </form>
			</div>
		</div>
